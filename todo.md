# Atualização de checkouts

- [x] Vincular os botões de inscrição da Formação Terapeutas Cristãs ao checkout Kiwify.
- [x] Vincular os botões da Formação em Teologia e Pós-Graduação aos respectivos checkouts Kiwify.
- [x] Vincular os cursos livres ao checkout PagBank.
- [x] Validar os links de inscrição e entregar a nova versão do site.
...
# Personalização visual da seção Sobre
